...
import sv.edu.bitlab.driver.JOB_ID
import sv.edu.bitlab.driver.MainActivity
...
class GeofenceTransitionsJobIntentService : JobIntentService() {
    ...
    private fun sendNotification(notificationDetails: String) {
        ...
        Log.d("GEO-NOTIFIFY","the string is  $notificationDetails")
    ...
    private fun getGeofenceTransitionDetails(geofenceTransition: Int, triggeringGeofences: List<Geofence>): String {
        ...
        Log.d("GEO-TRANSITION","the message -> $triggeringGeofencesIdsList")
